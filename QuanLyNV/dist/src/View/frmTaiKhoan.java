...
public class frmTaiKhoan extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        cboquyen.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        cboquyen.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Admin", "User" }));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(91, 91, 91)
                .addComponent(cboquyen, javax.swing.GroupLayout.PREFERRED_SIZE, 453, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(142, 142, 142)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(10, 10, 10)
                        .addComponent(jLabel8))
                    .addComponent(cboquyen, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(66, 66, 66)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuuActionPerformed
        ...
        if (them) {
            if (KTDL()) {
                ...
                try {
                    ...
                    String caulenh = "INSERT INTO tbl_taikhoan VALUES('" + manv + "','" + txtTenTaiKhoan.getText() + "','" + txtMatKhau.getText() + "',N'" + quyen + "')";
        ...
        if (sua) {
            ...
            try {
                Connection conn = dao.getConnect();
                String caulenh = "UPDATE tbl_taikhoan SET MatKhau='" + txtMatKhau.getText() + "',Quyen=N'" + quyen + "'where (MaNV=" + manv + " and TenTK='" + txtTenTaiKhoan.getText() + "')";
                boolean a = dao.Lenh(caulenh, conn);
                if (a) {
                    tblTaiKhoan.removeAll();
                    table.setRowCount(0);
    ...
    void hienthitxt(int i) {
        ...
        cboquyen.setSelectedItem(model.getValueAt(i, 3).toString());
